...
export default function Sidebar({ categories, product }) {
  ...
  return (
    <>
      <aside
        className={`sticky top-0 left-4 md:left-0 pt-20 h-screen bg-primary-color transition-all duration-300 ease-in-out z-40 ${isOpen ? "translate-x-0" : "-translate-x-full"}
